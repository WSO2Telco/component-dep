...
package com.wso2telco.workflow.approval.util;

public class Constants {



    public static final String WORKFLOW_REF_ID = "workflowRefId";
    public static final String CALL_BACK_URL = "callBackUrl";
    public static final String HUB_ADMIN_APPROVAL = "hubAdminApproval";
    public static final String HUB_WORKFLOW_CALLBACK_USERNAME_PROPERTY = "HUB_WORKFLOW_CALLBACK_USERNAME";
    public static final String HUB_WORKFLOW_CALLBACK_PASSWORD_PROPERTY = "HUB_WORKFLOW_CALLBACK_PASSWORD";
    ...
    public static final String SELECTED_TIER = "selectedTier";
    public static final String DESCRIPTION = "description";
    public static final String OPERATOR_CALLBACK_ACTIVITY = "Operator Callback";
