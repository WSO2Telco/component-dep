...
public class SQLConstants {
	...
	public static final String GET_APP_USER_SUBSCRIPTION_SQL = "SELECT APPNAME, APPLICATION_ID, USER_ID " +
			"FROM " +
			...
			"     AND SUB.USER_ID LIKE ? " +
			"   ORDER BY APP.NAME) AS apps group by APPNAME, USER_ID,APPLICATION_ID";

	public static final String GET_APP_USER_TIER_STATUS_SUBSCRIPTION_SQL = "SELECT DISTINCT (APPNAME), APPLICATION_ID, APPLICATION_TIER, APPLICATION_STATUS, USER_ID " +
			"FROM " +
			"  (SELECT APP.NAME AS APPNAME, " +
			"          API.API_NAME, " +
			"          SUB.USER_ID, " +
	...
	public static final String GET_API_FOR_USER_AND_APP_SQL = "SELECT API_ID, API_PROVIDER, API_NAME, API_VERSION FROM ( " +
			"SELECT API.API_ID AS API_ID, API" +
			...
			"'"+BlacklistWhitelistConstants.SubscriptionStatus.REJECTED +"' AND SUB.USER_ID LIKE ? AND APP.APPLICATION_ID LIKE " +
			"? ORDER BY APP.NAME) as result group by API_ID, API_PROVIDER, API_NAME, API_VERSION";
...
/*	public static final String GET_SUBSCRIPTION_ID_FOR_API_AND_APP_SQL = "SELECT SUBS.SUBSCRIPTION_ID AS SUBSCRIPTION_ID,  " +
	...
	public static final String GET_ALL_APPS_BY_SP_SQL =
			"  SELECT NAME, APPLICATION_ID, APPLICATION_TIER, APPLICATION_STATUS, CREATED_TIME FROM  AM_APPLICATION  " +
					"WHERE CREATED_BY = ? AND APPLICATION_STATUS!='CREATED' AND APPLICATION_STATUS!='REJECTED'";
