...
public class ValidatePaymentCharge  implements IServiceValidate {
    ...
    public ValidatePaymentCharge(boolean userAnonymization, String maskingSecretKey, String msisdnRegex) {
        ...
        //throw new UnsupportedOperationException("Not supported yet.");
            ...
            try {
                ...
                if (!jsonObj.isNull("endUserId")) {
                    ...
                    if(this.userAnonymization && UserMaskHandler.isMaskedUserId(endUserId, this.msisdnRegex)) {
