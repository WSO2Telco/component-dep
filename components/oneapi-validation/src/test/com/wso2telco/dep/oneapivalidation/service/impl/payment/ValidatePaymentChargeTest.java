...
public class ValidatePaymentChargeTest {
    ...
    public void testValidate_whenValidJson() {
        ...
        ValidatePaymentCharge validatePaymentCharge = new ValidatePaymentCharge(mockValidateValidationDelegator);
        validatePaymentCharge.validate(json);
    }
    ...
    public void testValidate_whenMaskedMSISDN() {
        ...
        ValidatePaymentCharge validatePaymentCharge = new ValidatePaymentCharge(userAnonymization,userMaskingSecretKey,mockValidateValidationDelegator);
        validatePaymentCharge.validate(json);
    }
    ...
    public void validateUrlTest_whenValidURL() {
        ...
        validatePaymentCharge.validateUrl(url);
    }
