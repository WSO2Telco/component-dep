...
public class ValidationRule {
    ...
    /**
     * The parameter must supplied and formatted as a number (double format)
     * greater than zero
     */
    public static final int VALIDATION_TYPE_MANDATORY_DOUBLE_GT_ZERO = 2;
    /**
     * The parameter must be supplied and formatted as a number (double format)
    ...
    /**
     * The parameter must supplied and formatted as a number (integer format)
     * greater than or equal to zero
     */
    ...
    /**
     * The parameter must supplied and match one of the valid channel types
     * ('Wap', 'Web', 'SMS')
     */
    public static final int VALIDATION_TYPE_MANDATORY_PAYMENT_CHANNEL = 30;

    /**
     * The parameter may be omitted but if supplied must have a (double) value
     * greater than zero
     */
    ...
    /**
     * The parameter may be omitted but if supplied must be in a correct
     * telephone number format
     */
    public static final int VALIDATION_TYPE_OPTIONAL_TEL = 105;
    /**
     * The parameter may be omitted but if supplied must be in a correct URL
     * format
     */
    public static final int VALIDATION_TYPE_OPTIONAL_URL = 110;
    /**
     * The parameter may be omitted but if supplied must have an (integer) value
     * greater than or equal to zero
     */
    ...
    /**
     * The parameter may be omitted but if supplied must match one of the valid
     * channel types ('Wap', 'Web', 'SMS')
     */
    ...
    public static final int VALIDATION_TYPE_MANDATORY_FOR_NUMBER_REPLACE_TEL = 139;

    public static final int VALIDATION_TYPE_MANDATORY_LOC_ACCURACY = 140;
    
    public static final int VALIDATION_TYPE_OPTIONAL_TEL_END_USER_ID = 141;
    
    public static final int VALIDATION_TYPE_OPTIONAL_CURRENCY = 142;
    ...
    /**
     * Parameter name is used in sending an error message back to the calling
     * client if there is a problem
     */
    String parameterName = null;
    /**
     * The parameter value to check against. The validation functions check the
     * object type when validating.
     */
    ...
    public static boolean isMandatory(int type) {
        ...
        switch (type) {
            ...
            case VALIDATION_TYPE_MANDATORY_NUMBER:
                mandatory = true;
                break;
            case VALIDATION_TYPE_MANDATORY_FOR_NUMBER_REPLACE_TEL:
                mandatory = true;
                break;
            case VALIDATION_TYPE_MANDATORY_LOC_ACCURACY:
                mandatory = true;
                break;
        }
