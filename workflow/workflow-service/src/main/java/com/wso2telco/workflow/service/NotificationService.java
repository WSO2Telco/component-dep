...
public class NotificationService {
    ...
    @POST
    @Path("subscription/approval/hub")
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @POST
    @Path("application/approval/plugin")
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @POST
    @Path("subscription/approval/plugin")
    @Consumes(MediaType.APPLICATION_JSON)
