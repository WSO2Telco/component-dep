...
public class ValidateWalletPayment implements IServiceValidate {
    
    private final String[] validationRules = {"transaction", "*","payment"};
        ...
        //throw new UnsupportedOperationException("Not supported yet.");
           ...
           String originalServerReferenceCode = null;
            ...
            try {
                ...
                JSONObject jsonObj = (JSONObject) mainJSONObject.get("makePayment");
                ...
                if (!jsonObj.isNull("paymentAmount")) {
                    paymentAmount = nullOrTrimmed(jsonObj.getString("paymentAmount"));
                }
                if (!jsonObj.isNull("notifyURL")) {
                    notifyURL = nullOrTrimmed(jsonObj.getString("notifyURL"));
                }
