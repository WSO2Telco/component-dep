...
CREATE TABLE "api_operation"(
  ...
  INDEX "fk_api_operation_1_idx" ("apiid")
);
...
CREATE TABLE "operation_rate"(
  ...
  INDEX "fk_operation_rate_1_idx" ("api_operationid"),
  INDEX "fk_operation_rate_2_idx" ("rate_defid"),
  INDEX "fk_operation_rate_3_idx" ("operator_id")
);
...
CREATE TABLE "rate_category"(
  ...
  CONSTRAINT "fk_rate_category_4"
    ...
    REFERENCES "category" ("categoryid") ON DELETE CASCADE ON UPDATE CASCADE,
  INDEX "fk_rate_category_1_idx" ("rate_defid"),
  INDEX "fk_rate_category_2_idx" ("tariffid"),
  INDEX "fk_rate_category_3_idx" ("parentcategoryid"),
  INDEX "fk_rate_category_4_idx" ("childcategoryid")
);
...
CREATE TABLE "rate_def"(
  ...
  CONSTRAINT "fk_rate_def_3"
    FOREIGN KEY ("tariffid")
    REFERENCES "tariff" ("tariffid") ON DELETE CASCADE ON UPDATE CASCADE,
  INDEX "fk_rate_def_1_idx" ("rate_typeid"),
  INDEX "fk_rate_def_2_idx" ("currencyid"),
  INDEX "fk_rate_def_3_idx" ("tariffid")
);
...
CREATE TABLE "rate_taxes"(
  ...
  INDEX "fk_rate_taxes_1_idx" ("rate_defid"),
  INDEX "fk_rate_taxes_2_idx" ("taxid")
);
...
CREATE TABLE "sub_rate_nb"(
  ...
  CONSTRAINT "fk_sub_rate_nb_2"
    FOREIGN KEY ("rate_defid")
    REFERENCES "rate_def" ("rate_defid") ON DELETE CASCADE ON UPDATE CASCADE,
  INDEX "fk_sub_rate_nb_1_idx" ("api_operationid"),
  INDEX "fk_sub_rate_nb_2_idx" ("rate_defid")
);
...
CREATE TABLE "sub_rate_sb"(
  ...
  CONSTRAINT "fk_sub_rate_sb_3"
    FOREIGN KEY ("rate_defid")
    REFERENCES "rate_def" ("rate_defid") ON DELETE CASCADE ON UPDATE CASCADE,
  INDEX "fk_sub_rate_sb_1_idx" ("operatorid"),
  INDEX "fk_sub_rate_sb_2_idx" ("api_operationid"),
  INDEX "fk_sub_rate_sb_3_idx" ("rate_defid")
);
...
CREATE TABLE "tax_validity"(
  ...
  INDEX "fk_tax_validity_1_idx" ("taxid")
);
