...
function setTierDetailsToToolTip(tierAttributevalue, lblInfo){
	tierAttributevalue = tierAttributevalue.replace('<div xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tschema="http://workflow.application.apimgt.carbon.wso2.org" xmlns="">','<div>');
