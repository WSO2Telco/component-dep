...
<%
    ...
    if (request.getSession().getAttribute("user_profile_id") != null) {
        profileid = request.getSession().getAttribute("user_profile_id").toString();

        ResultSet r = UserData.getProfileData(profileid);
        try {
            while (r.next()) {
                ...
                timezone = r.getString("date_of_birth");
                ...
                jobTitle = r.getString("job_title");
                jobFunction = r.getString("job_function");

                if (r.getInt("subscribe_status") == 1) {
                    isSubscribed = true;
                } else {
                    isSubscribed = false;
                }
            ...
            System.out.println("Reding profile data: " + e);
        }
    } else {
        ...
        <div id="fullContainer">
            ...
            <div id="body_container" class="container_12 clearfix">
                ...
                <div class="grid_12">
                    ...
                    <!-- Content:START -->
                    <div id="inputArea">
                        <form action="EditProfile" method="POST" name="userProfileForm" id="userProfileForm">
                            <div class="grid_12 break">
                                ...
                                <div class="grid_6 alpha">
                                    ...
                                    <p><label for="firstName">First Name</label><span class="requiredField ">*</span><br/>
                                        <input id="firstName" name="firstname" class="wide" value="<%= firstName %>" required="required" type="text" />
                                    </p>

                                    <p><label for="lastName">Last Name</label><span class="requiredField ">*</span><br/>
                                        <input id="lastName" name="lastname" class="medium" value="<%= lastName %>" required="required" type="text" />

                                    </p>

                                    <p><label for="newEmail">Email</label><span class="requiredField ">*</span><br/>
                                        <input id="newEmail" name="email" class="wide" value="<%= email %>" required="required" type="text" />
                                    ...
                                    <p>
                                        ...
                                        <input id="telephone" name="telephone" value="<%= telephone %>" type="text"/>
                                    ...
                                    <p>
                                        ...
                                        <input id="fax" name="fax" class="wide" value="<%= fax %>" type="text"/>
                                    ...
                                    <p>
                                        ...
                                        <br/>
                                        <input name="date_of_birth" value="date.struct" type="hidden"/>
                                    ...
                                    <p>
                                        ...
                                        <input name="website" id="website" value="<%= website %>" type="text"/>
                                    </p>

                                    <p>
                                        <label for="twitter">Twitter</label><br/>
                                        <input name="twitter" id="twitter" value="<%= twitter %>" type="text"/>
                                    </p>

                                    <h2>Options</h2>
                                    <p>
                                        <input name="_receiveCommunications" type="hidden"/>
                                        <input name="receiveCommunications" id="receiveCommunications" type="checkbox" <% if(isSubscribed){ out.print("checked"); } %> />
                                        <label for="receiveCommunications">Receive email communications from MIFE?</label>
                                    </p>
                                ...
                                <div class="grid_6 omega">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="grid_1 alpha">
                                            <img id="avatarImage" alt="null" class="[:]" src="profilepics/FB-profile-avatar.jpg" height="80" width="80"></img><br/>
                                    ...
                                    <p><label for="displayName">Display Name</label><span class="requiredField ">*</span><br/>
                                        <input id="displayName" name="displayname" class="wide" value="<%= displayName %>" required="required" type="text"/>

                                    </p>

                                    <p><label for="signature">Signature</label><br/>
                                        <textarea id="signature" name="signature" rows="6" cols="40"><%= signature %></textarea>
                                    ...
                                    <p>
                                        ...
                                        <br/>
                                        <input name="company_name" id="company" value="<%= companyName %>" type="text"/>
                                    </p>
                                    <p>
                                        <label for="jobTitle">Job Title</label>
                                        <br/>
                                        <input name="job_title" id="jobTitle" value="<%= jobTitle %>" type="text"/>
                                    </p>
                                    <p>
                                        <label for="jobFunction">Job Function</label>
                                        <br/>
                                        <select name="job_function" id="jobFunction">
                            ...
                            <div class="grid_12">
                                <br/>
                                <p align="right"><button type="submit">Update Profile</button> or <a href="profile.jsp">Cancel</a></p>
                            </div>
                        </form>
                    </div>
                    <!-- Content:END -->
