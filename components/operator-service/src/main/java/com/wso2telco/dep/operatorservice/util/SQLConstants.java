...
/*	public static final String GET_SUBSCRIPTION_ID_FOR_API_AND_APP_SQL = "SELECT SUBS.SUBSCRIPTION_ID AS SUBSCRIPTION_ID,  " +
	...
	public static final String GET_ALL_APPS_BY_SP_SQL =
			"  SELECT NAME, APPLICATION_ID, APPLICATION_TIER, APPLICATION_STATUS, UPDATED_TIME FROM  AM_APPLICATION  WHERE CREATED_BY = ? AND APPLICATION_STATUS!='CREATED' AND APPLICATION_STATUS!='REJECTED'";
