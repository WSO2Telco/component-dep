...
$(document).ready(function(){
    axiata_db.r2_c2.init();
    axiata_db.chartBox.initDropdown('operator_r2_c2',function(){
        axiata_db.r2_c2.init();
    });

    axiata_db.chartBox.initDropdown('time_r2_c2',function(){
        axiata_db.r2_c2.init();
    });
});