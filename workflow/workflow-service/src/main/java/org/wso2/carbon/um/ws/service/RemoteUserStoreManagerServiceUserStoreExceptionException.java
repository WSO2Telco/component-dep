...
public class RemoteUserStoreManagerServiceUserStoreExceptionException extends Exception{
    ...
    private org.wso2.carbon.um.ws.service.RemoteUserStoreManagerServiceStub.RemoteUserStoreManagerServiceUserStoreException faultMessage;
        ...
        public RemoteUserStoreManagerServiceUserStoreExceptionException(String s) {
           super(s);
        }

        public RemoteUserStoreManagerServiceUserStoreExceptionException(String s, Throwable ex) {
          super(s, ex);
        }

        public RemoteUserStoreManagerServiceUserStoreExceptionException(Throwable cause) {
            super(cause);
        }
