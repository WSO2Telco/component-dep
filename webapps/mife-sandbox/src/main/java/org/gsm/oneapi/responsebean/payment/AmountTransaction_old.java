...
/**
 * The main part of the OneAPI response for the Charge/ Refund payment
 * operations
 */
public class AmountTransaction_old implements java.io.Serializable {
    ...
    /**
     * is your reference for reconciliation purposes. The operator should
     * include it in reports so that you can match their view of what has been
     * sold with yours by matching the referenceCodes.
     */
    private String referenceCode = null;
    /**
     * the server's reference code for this payment request - it must be used in
     * any related payment requests
     */
    ...
    /**
     * return the clientCorrelator ensures the same payment request is only
     * applied once
     */
    ...
    /**
     * return your reference for reconciliation purposes. The operator should
     * include it in reports so that you can match their view of what has been
     * sold with yours by matching the referenceCodes.
     */
    ...
    /**
     * return the server's reference code for this payment request - it must be
     * used in any related payment requests
     */
    ...
    /**
     * set the clientCorrelator ensures the same payment request is only applied
     * once. This is called internally to set the contents according to the JSON
     * response.
     */
    ...
    /**
     * set your reference for reconciliation purposes. The operator should
     * include it in reports so that you can match their view of what has been
     * sold with yours by matching the referenceCodes.. This is called
    ...
    /**
     * set the server's reference code for this payment request - it must be
     * used in any related payment requests. This is called internally to set
     * the contents according to the JSON response.
     */
    ...
    /**
     * set the server allocated reference URL for this payment request. This is
     * called internally to set the contents according to the JSON response.
     */
    ...
    /**
     * set confirmation of the charging operation. This is called internally to
     * set the contents according to the JSON response.
     */
    ...
    /**
     * the details of the actual payment are confirmed in the PaymentAmount
     * inner class
     */
    public static class PaymentAmount {
        ...
        public static class ChargingInformation {
            ...
            /**
             * an indication of the content type. Values meaningful to the
             * billing system would be published by a OneAPI implementation.
             */
            ...
            /**
             * return an indication of the content type. Values meaningful to
             * the billing system would be published by a OneAPI implementation.
             */
            ...
            /**
             * set the amount to be charged/ refunded. This is called internally
            ...
            /**
             * set the currency being charged. This is called internally to set
             * the contents according to the JSON response.
             */
            ...
            /**
             * set the description of the item being charged/ refunded. This is
             * called internally to set the contents according to the JSON
             * response.
             */
            ...
            /**
             * set an indication of the content type. Values meaningful to the
             * billing system would be published by a OneAPI implementation.
             * This is called internally to set the contents according to the
             * JSON response.
             */
     ...
     */
    private AmountTransaction.PaymentAmount paymentAmount = null;
    ...
    /**
     * generate a textual representation of the AmountTransaction including all
