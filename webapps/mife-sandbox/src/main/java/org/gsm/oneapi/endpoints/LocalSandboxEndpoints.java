...
//	
	public void reset(String prefix) {
		...
		endpoints.AmountCharge=prefix+"AmountChargeService/payment/1/transactions/amount";
//                endpoints.AmountCharge=prefix+"AmountChargeService/1/payment/{endUserId}/transactions/amount";
		...
		endpoints.Location=prefix+"LocationService/1/location/queries/location";
                ...
                endpoints.SendSMS=prefix+"SendSMSService/smsmessaging/1/outbound/{senderAddress}/requests";
		endpoints.QuerySMSDelivery=prefix+"QuerySMSService/smsmessaging/1/outbound/{senderAddress}/requests/{requestId}/deliveryInfos";
		...
		endpoints.RetrieveSMS=prefix+"RetrieveSMSService/smsmessaging/1/inbound/registrations/{registrationId}/messages/?maxBatchSize={maxBatchSize}";
		endpoints.SMSReceiptSubscriptions=prefix+"SMSReceiptService/smsmessaging/1/inbound/subscriptions";
		endpoints.CancelSMSReceiptSubscription=prefix+"CancelSMSReceiptService/smsmessaging/1/inbound/subscriptions/{subscriptionId}";		
	...
	public void reset() {
		reset("http://localhost:8080/mifeapiserver/");
	}
