...
import com.wso2telco.dep.oneapivalidation.service.impl.ValidateWalletBalance;
import com.wso2telco.dep.oneapivalidation.exceptions.CustomException;
import com.wso2telco.dep.oneapivalidation.service.IServiceValidate;
import com.wso2telco.dep.subscriptionvalidator.util.ValidatorUtils;

public class WalletBalanceHandler implements WalletHandler{

    private Log log = LogFactory.getLog(WalletBalanceHandler.class);
    ...
    public WalletBalanceHandler(WalletExecutor executor) {
    ...
    public boolean handle(MessageContext context) throws Exception {
        ...
        if (ValidatorUtils.getValidatorForSubscription(context).validate(context)) {
            endpoint = occi.getAPIEndpointsByMSISDN(params[2].replace("tel:", ""), API_TYPE, executor.getSubResourcePath(), true,
    ...
    public boolean validate(String httpMethod, String requestPath, JSONObject jsonBody, MessageContext context) throws Exception {
        ...
        String[] params = executor.getSubResourcePath().split("/");
        IServiceValidate validator = new ValidateWalletBalance();
