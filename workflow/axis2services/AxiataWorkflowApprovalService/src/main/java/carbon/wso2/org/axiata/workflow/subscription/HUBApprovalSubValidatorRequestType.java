 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":HUBApprovalSubValidatorRequestType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "HUBApprovalSubValidatorRequestType",
                           xmlWriter);
                   }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://org.wso2.carbon/axiata/workflow/subscription";
                                    writeStartElement(null, namespace, "apiID", xmlWriter);
                             

                                          if (localApiID==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("apiID cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localApiID);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://org.wso2.carbon/axiata/workflow/subscription",
                                        ...
                                        if (localApiID != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localApiID));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("apiID cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static HUBApprovalSubValidatorRequestType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            HUBApprovalSubValidatorRequestType object =
                new HUBApprovalSubValidatorRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"HUBApprovalSubValidatorRequestType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (HUBApprovalSubValidatorRequestType)carbon.wso2.org.axiata.workflow.common.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.wso2.carbon/axiata/workflow/subscription","apiID").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"apiID" +"  cannot be null");
                                    }
