...
/**
 * Class used as the key for RateCard map. Used to combine multiple keys such as
 * operatorName, apiName, rateName and set as the single key. Uses
 * case-insensitive equals() and hashCode() implementations to allow for
 * case-insensitive lookup through the rateCard map.
 */
class RateKey {
    ...
    /*    public RateKey(String operator, String apiName, String rateName) {
...
enum RateType {
    ...
    /**
     * A constant charge upto the quota value and a different rate for the
     * excess count.
     */
    QUOTA("QUOTA"),
    /**
