...
public class ValidateSendSms implements IServiceValidate {
    ...
    public ValidateSendSms(boolean userAnonymization, String maskingSecretKey, String msisdnRegex) {
        ...
        try {
            ...
            if (!objOtboundSMSMessageRequest.isNull("address")) {
                ...
                for (int a = 0; a < addressArray.length(); a++) {
                    if(this.userAnonymization && UserMaskHandler.isMaskedUserId(addressArray.getString(a), this.msisdnRegex)) {
