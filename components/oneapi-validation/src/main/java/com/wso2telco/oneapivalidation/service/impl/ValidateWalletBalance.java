...
public class ValidateWalletBalance implements IServiceValidate {

	static Logger logger = Logger.getLogger(ValidateWalletBalance.class);
	private final String[] validationRules = { "transaction", "*", "balance" };

	public void validate(String[] params) throws CustomException {

		String endUserId = nullOrTrimmed(params[2]);
		logger.debug("ValidateWalletBalance -- validate -> endUserId : "
				+ endUserId);
