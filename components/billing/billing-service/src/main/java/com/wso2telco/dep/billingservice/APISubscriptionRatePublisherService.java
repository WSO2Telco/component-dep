...
public class APISubscriptionRatePublisherService implements BillingHandlerExtension {
	...
	public void publishHubAPIRate(int servicesRateDid, int applicationDid ,String apiVersion) throws BusinessException {
		try {
			...
			rateCardService.setHubSubscriptionRateData(servicesRateDid, applicationDid,apiVersion);
		} catch (Exception e) {
	...
	public void publishOperatorAPIRate(int operatorRateDid, int applicationDid , String apiVersion) throws BusinessException {
		try {
			...
			RateCardService rateCardService = new RateCardService();
			rateCardService.setOperatorSubscriptionRateData(operatorRateDid, applicationDid, apiVersion);
		} catch (Exception e) {
