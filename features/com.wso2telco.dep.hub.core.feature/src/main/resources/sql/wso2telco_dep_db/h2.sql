...
CREATE INDEX "fk_mdtrequestmessage_1_idx" ON "mdtrequestmessage" ("msgtypeId");
CREATE INDEX "index_msgtypeId" ON "mdtrequestmessage" ("msgtypeId");
CREATE INDEX "index_clientrefcode" ON "mdtrequestmessage" ("clientrefcode");
...
CREATE INDEX "index_msisdn" ON "spendlimitdata" ("msisdn");
CREATE INDEX "index_msgType" ON "spendlimitdata" ("msgType");
