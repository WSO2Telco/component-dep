...
(function () {
    ...
    jagg.messageDisplay = function (params) {
        ...
        if (params.title == undefined) {
            $('#messageModal h3.modal-title').html('APIManager Admin Module');
        } else {
    ...
    jagg.message = function(params) {
        ...
        jagg.messageDisplay({content:params.content,title:"APIManager Admin Module - " + type,buttons:[
