...
public class EventsDataPublisherClient {
	...
	public void publishEvent(MessageContext mc) {
		...
		dataPublisherDTO.setOperatorId((String) mc.getProperty(EventsConstants.OPERATOR_ID));
		dataPublisherDTO.setResponseCode((String) mc.getProperty(EventsConstants.RESPONSE_CODE));
		dataPublisherDTO.setMsisdn((String) mc.getProperty(EventsConstants.MSISDN));
		String chargeAmountStr = (String) mc.getProperty(EventsConstants.CHARGE_AMOUNT);
